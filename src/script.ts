...
function generateWord(category:string){
    let array = (words as any)[category];
...
function verifyLetter(key:string,item: any){
    let wordArray = word.split("");
    let letterPos:number[] = [];
    let forcaImg = document.querySelector(".forca-img img") as HTMLImageElement;
    let HTMLWord = document.querySelector(".guess-area span");
...
function openModal(src:string, text:string){
    let img = Modal.querySelector(".content img") as HTMLImageElement;
